...
public record ProjectMetaDto(
  ...
  public ProjectMetaDto withName(String newName) {
    return new ProjectMetaDto(id, newName, createdAt, updatedAt, hasDraft, assets);
  }
  ...
  public ProjectMetaDto withUpdatedAt(Instant newUpdatedAt) {
    return new ProjectMetaDto(id, name, createdAt, newUpdatedAt, hasDraft, assets);
  }
  ...
  public ProjectMetaDto withHasDraft(boolean newHasDraft) {
    return new ProjectMetaDto(id, name, createdAt, updatedAt, newHasDraft, assets);
  }
  ...
  public ProjectMetaDto withAssets(List<String> newAssets) {
    return new ProjectMetaDto(id, name, createdAt, updatedAt, hasDraft, newAssets);
  }
}
